...
export default function ProgramUnggulan() {
    ...
    const ApiBerita = "https://admin.smkskrian1.com/api/daftar-program-unggulan?page=1";
    ...
    const fetchPages = async (currnetPage) => {
        const response = await fetch(`https://admin.smkskrian1.com/api/daftar-program-unggulan?page=${currnetPage}`);
